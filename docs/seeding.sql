...
INSERT INTO __drizzle_migrations VALUES(NULL,'5b7d5a9c018af6bb04733377e710b6c0ac41ababcb5970d9d66b3c482d983f05',1738450693722);
CREATE TABLE `command` (
	...
	FOREIGN KEY (`family`) REFERENCES `family`(`id`) ON UPDATE cascade ON DELETE cascade
);
